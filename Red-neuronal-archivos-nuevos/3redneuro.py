...
modelo = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(10, activation='softmax') # Capa de salida con 10 neuronas (una por cada número)
])
...
print('Real: 0')
img_nueva = cv2.imread("0prueba.jpg", 0)
...
img_nueva = cv2.imread("1prueba.jpg", cv2.IMREAD_GRAYSCALE)
img_nueva = cv2.bitwise_not(img_nueva)
...
img_nueva = cv2.imread("2prueba.jpg", cv2.IMREAD_GRAYSCALE)
img_nueva = cv2.bitwise_not(img_nueva)
...
img_nueva = cv2.imread("4prueba.jpg", cv2.IMREAD_GRAYSCALE)
img_nueva = cv2.bitwise_not(img_nueva)
...
img_nueva = cv2.imread("5prueba.jpg", cv2.IMREAD_GRAYSCALE)
img_nueva = cv2.bitwise_not(img_nueva)
...
img_nueva = cv2.imread("9prueba.jpg", cv2.IMREAD_GRAYSCALE)
img_nueva = cv2.bitwise_not(img_nueva)
